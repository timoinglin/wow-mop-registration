...
- **Armory Talents — in-game-style 6×3 grid** for all 11 classes (192/198 talent IDs verified one-shot against Wowhead's mop-classic redirect slugs; the 6 unverified cells render as empty so the grid still draws — chip view continues to back chosen talents). Chosen talent glows in the class colour; unchosen options dimmed. Mobile: 1-column stack.
